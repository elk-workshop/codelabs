...
![gartner-grid-gartner-mq-insight-engines-2021](images/ent-search/gartner-grid-gartner-mq-insight-engines-2021.png)
...
![2021-04-21_12-44-06](images/ent-search/2021-04-21_12-44-06.png)



本课程所使用到的 Elastic Stack 的组件包括：

* Elasticsearch、Kibana 的版本是 7.12. 0

* Elastic Enterprise Search 7.12.0
...
elasticsearch.password: "uhUvrtY0S62XbnvEPLja"
